import logo from '../images/logo.png'; // Import the logo image from the relative path for use in the component

const Reservation = () => {
    return (
        <div className="p-5"> {/*Wrapper div with padding applied*/} 
            <div className="card mx-auto" style={{width: "400px"}}> {/* Card component centered horizontally with a fixed width*/}
                <div className="card-body"> {/* Card body for internal content*/}
                    <div className="mb-8 text-center">
                        <img src={logo} alt="Logo" width="100" height="100" className="bi"/> 
                        <h5 className="card-title">Make A Reservation Today</h5> 
                    </div>
                    <form className="row g-3"> 
                        {/* Each form group below consists of an input field and an associated label */}
...
export default Reservation; // Exporting the component for use in other parts of the application