...
const SignUp = () => {
    return (
        ...
        <div className="p-5">
            {/* Card component to display the sign-up form centered on the page */}
            <div className="card mx-auto" style={{ width: "400px" }}>
                <div className="card-body">
                    ...
                    <form className="row g-3">
                        ...
                        {/* Text and link for users with an existing account to sign in */}
