...
// The Layout component represents the main structure of the page, including the navigation bar, content area, and footer.
const Layout = () => {
  return (
    <>
      {/* Navigation Bar */}
      <nav className="navbar navbar-expand-lg sticky-top bg-body-tertiary">
        <div className="container-fluid">
          ...
          {/* Link to the homepage with logo and brand name */}
          ...
          <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul className="navbar-nav">
              {/* Menu link - directs to the homepage */}
              <li className="nav-item">
                <Link to="/" className="nav-link active" aria-current="page">Menu</Link>
              </li>
              {/* View Order link - directs to the checkout page */}
              <li className="nav-item">
                <Link to="/checkout" className="nav-link">View Order</Link>
              </li>
              {/* Reservation link - directs to the reservation page */}
              <li className="nav-item">
                <Link to="/reservation" className="nav-link">Reservation</Link>
              </li>
              {/* Sign In link - directs to the sign-in page */}
              <li className="nav-item">
      ...
      {/* Placeholder for rendering nested routes (if any) */}
      <Outlet />
      ...
      <div className="container">
        <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
          ...
          {/* Left side of footer: logo and copyright text */}
          ...
          <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
            {/* Twitter link with corresponding icon */}
            <li className="ms-3">
            ...
            {/* Instagram link with corresponding icon */}
            <li className="ms-3">
              <Link className="text-body-secondary" to="#">
            ...
            {/* Facebook link with corresponding icon */}
            <li className="ms-3">
              <Link className="text-body-secondary" to="#">
...
// Exporting the Layout component to be used elsewhere in the application.
